...
st.markdown(
    ...
    div.stButton > button:hover {
        background: linear-gradient(135deg, rgba(56, 189, 248, 0.2), rgba(147, 51, 234, 0.3)) !important;
        color: #ffffff !important;
        border: 1px solid rgba(56, 189, 248, 0.6) !important;
        transform: translateY(-2px);
        box-shadow: 0 0 25px rgba(56, 189, 248, 0.4), inset 0 1px 2px rgba(255, 255, 255, 0.3);
    }
    </style>
""",
...
if st.session_state.level == 30:
  ending_html = """
    ...
    <body>
        ...
        <script>
            ...
            const coreGeo = new THREE.TorusKnotGeometry(3.2, 1.1, 128, 32, 2, 3);
  ...
  # -----------------------------------------------------------------------------
  # 상하 배치 (위: 3D 시각화 및 핵심 정보, 아래: 강화 제어 및 상점)
  # -----------------------------------------------------------------------------
  ...
  three_js_code = f"""
    ...
    """
  components.html(three_js_code, height=450, scrolling=False)
  ...
  info_card_html = f"""
    ...
    <div class="info-card-box" style="{shake_style}">
        ...
        <div style="font-size: 12px; color: #cbd5e1; margin-bottom: 8px; font-style: italic;">"{c_desc}"</div>
...
"""
  ...
  with r_col4:
    ...
    st.markdown(
        f"<div style='text-align: center;'><div style='font-size:12px;"
        f" color:#fde68a;'>✨ 자이온맘의 가호</div><div style='font-size:14px;"
