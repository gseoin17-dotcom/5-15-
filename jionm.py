...
SMELL_DB = {
    ...
    True: {
        ...
        5: {
            ...
            "price": 120000000000,  # 1,200억으로 상향
            "color": "#38a169",
            "tier": 2,
        },
        6: {
            ...
            "price": 300000000000,  # 3,000억으로 상향
            "color": "#805ad5",
            "tier": 3,
        },
        7: {
            ...
            "price": 700000000000,  # 7,000억으로 상향
            "color": "#e53e3e",
            "tier": 3,
        },
        8: {
            ...
            "price": 1500000000000,  # 1조 5,000억으로 상향
            "color": "#ff4500",
            "tier": 3,
        },
        9: {
            ...
            "price": 3500000000000,  # 3조 5,000억으로 상향
            "color": "#0088ff",
            "tier": 4,
        },
        10: {
        ...
        14: {
            ...
            "price": 200000000000000,  # 200조로 상향
            "color": "#00ff66",
            "tier": 5,
        },
        15: {
            ...
            "price": 450000000000000,  # 450조로 상향
            "color": "#ff00ea",
            "tier": 6,
        },
        16: {
            ...
            "price": 1000000000000000,  # 1,000조(1경)로 상향
            "color": "#ccff00",
            "tier": 6,
        },
        17: {
            ...
            "price": 2500000000000000,  # 2,500조로 상향
            "color": "#ff6600",
            "tier": 6,
        },
        18: {
            ...
            "price": 6000000000000000,  # 6,000조로 상향
            "color": "#00f0ff",
            "tier": 6,
        },
        19: {
            ...
            "price": 15000000000000000,  # 1만 5,000조로 상향
            "color": "#ffe600",
            "tier": 6,
        },
        20: {
            ...
            "price": 35000000000000000,  # 3만 5,000조로 상향
            "color": "#ff00aa",
            "tier": 6,
        },
        21: {
            ...
            "price": 80000000000000000,  # 8만조로 상향
            "color": "#ffffff",
            "tier": 6,
        },
        22: {
            ...
            "price": 180000000000000000,  # 18만조로 상향
            "color": "#7b00ff",
            "tier": 6,
        },
        23: {
            ...
            "price": 400000000000000000,  # 40만조로 상향
            "color": "#00ffff",
            "tier": 6,
        },
        24: {
            ...
            "price": 1000000000000000000,  # 100만조(1해)로 상향
            "color": "#ff4500",
            "tier": 6,
        },
        25: {
            ...
            "price": 10000000000000000000,  # 1,000만조(10해)로 상향
            "color": "#ffffff",
            "tier": 6,
        },
    },
