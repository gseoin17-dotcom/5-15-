...
const MAX_LEVEL = 55;
const SHIELD_MAX = 6;
const WARP_LEVELS = [10,15,20,25,30,35,40,45];
const ENHANCE_COST = {"0":10,"1":10,"2":20,"3":40,"4":50,"5":70,"6":100,"7":140,"8":210,"9":280,"10":350,"11":490,"12":630,"13":840,"14":1120,"15":1470,"16":1960,"17":2590,"18":3290,"19":4270,"20":5530,"21":7350,"22":9450,"23":12600,"24":16450,"25":21350,"26":28350,"27":36400,"28":45500,"29":58100,"30":77000,"31":98000,"32":122500,"33":157500,"34":203000,"35":259000,"36":329000,"37":427000,"38":535500,"39":679000,"40":875000,"41":1120000,"42":1400000,"43":1785000,"44":2310000,"45":3010000,"46":3920000,"47":5180000,"48":6930000,"49":9100000,"50":12600000,"51":17500000,"52":23800000,"53":32900000,"54":45500000};
...
const LEGACY_V13_PRICE = {"0":0,"1":150,"2":400,"3":600,"4":800,"5":3000,"6":3500,"7":6100,"8":10000,"9":20000,"10":35100,"11":160000,"12":350000,"13":1000000,"14":3000000,"15":7500000,"16":14200000,"17":20000000,"18":30000000,"19":47500000,"20":68300000,"21":101000000,"22":160000000,"23":230000000,"24":300000000,"25":400000000,"26":1800000000,"27":2500000000,"28":5500000000,"29":10500000000,"30":20000000000,"31":45000000000,"32":90000000000,"33":200000000000,"34":500000000000,"35":1000000000000,"36":2500000000000,"37":6000000000000,"38":15000000000000,"39":35000000000000,"40":80000000000000,"41":180000000000000,"42":400000000000000,"43":900000000000000,"44":2000000000000000,"45":4500000000000000,"46":10000000000000000,"47":22000000000000000,"48":50000000000000000,"49":120000000000000000,"50":280000000000000000,"51":600000000000000000,"52":1300000000000000000,"53":3000000000000000000,"54":7000000000000000000,"55":15000000000000000000};
const RESEARCH_MAX=5;
const LAB_COST_MULTIPLIER=.55;
const CORE_FUSION_MIN_LEVEL=5;
const CORE_FUSION_COST=60000;
const CORE_FUSION_RESET_REFUND_RATE=.50;
const CORE_FUSION_GRADES=[
  {min:47,max:53,name:"PERFECT",boost:.30,label:"완벽 공명"},
  {min:42,max:58,name:"GREAT",boost:.24,label:"고출력 공명"},
  {min:34,max:66,name:"GOOD",boost:.18,label:"안정 공명"},
  {min:24,max:76,name:"STABLE",boost:.12,label:"기본 공명"}
];
const RESEARCH_DATA={
  catalyst:{icon:"🧬",slot:"CORE",name:"악취 촉매 코어",desc:"강화 성공 확률을 높이는 고농축 촉매 코어.",effect:"성공 확률",unit:"+0.8%p",cost:[3000,9000,27000,80000,240000],success:[92,84,75,64,52]},
  safety:{icon:"🛡️",slot:"ARMOR",name:"안정화 실드 플레이트",desc:"파괴 에너지를 흡수해 일부를 유지 판정으로 전환합니다.",effect:"파괴 확률",unit:"-0.9%p",cost:[2500,7500,22000,65000,195000],success:[90,81,71,60,48]},
  economy:{icon:"⚙️",slot:"DRIVE",name:"저전력 압축 터빈",desc:"강화 장치의 에너지 손실을 줄여 강화 비용을 절감합니다.",effect:"강화 비용",unit:"-3.5%",cost:[2000,6000,18000,54000,162000],success:[95,88,79,69,57]},
  insight:{icon:"📡",slot:"SENSOR",name:"냄새 분석 센서",desc:"강화 성공 데이터를 분석해 획득 포인트를 늘립니다.",effect:"성공 포인트",unit:"+7%",cost:[1500,4500,13500,40500,121500],success:[94,87,80,70,59]},
  resale:{icon:"🔗",slot:"VALVE",name:"연쇄 보존 밸브",desc:"파괴가 아닌 실패·유지·방지권 생존 시 연속 콤보가 끊기지 않을 확률을 높입니다.",effect:"콤보 보존",unit:"+14%",cost:[1800,5400,16000,48000,144000],success:[91,83,73,62,51]},
  capacitor:{icon:"🔥",slot:"FRENZY",name:"폭주 축전기",desc:"실패 에너지 회수 효율을 높여 냄새 폭주 게이지를 더 빠르게 충전합니다.",effect:"폭주 충전",unit:"+12%",cost:[2200,6600,19800,59400,178000],success:[89,80,69,58,46]},
  precision:{icon:"🎯",slot:"OPTIC",name:"정밀 판정 렌즈",desc:"일반 강화의 크리티컬 확률을 높입니다. 광폭 강화에는 적용되지 않으며 50단계부터 크리티컬이 비활성입니다.",effect:"크리티컬",unit:"+1.7%p",cost:[2800,8400,25200,75600,226800],success:[88,78,67,55,43]},
  shieldTech:{icon:"🔧",slot:"SHIELD",name:"방지권 재생 모듈",desc:"방지권 제작 공정을 개선해 돈·포인트 구매 가격을 낮춥니다.",effect:"방지권 가격",unit:"-7%",cost:[2400,7200,21600,64800,194400],success:[93,85,76,65,54]},
  warpTech:{icon:"🧭",slot:"WARP",name:"차원 고정 코어",desc:"워프 직후 첫 유료 강화의 성공 확률을 높입니다. 워프 비용이나 판매 금액에는 영향을 주지 않습니다.",effect:"워프 후 성공",unit:"+2.2%p",cost:[3200,9600,28800,86400,259200],success:[87,77,66,54,42]},
  fusion:{icon:"🧪",slot:"FUSION",name:"실드 순환 컨트롤러",desc:"방지권이 발동했을 때 일정 확률로 방지권을 소모하지 않고 재사용할 수 있게 합니다.",effect:"방지권 보존",unit:"+12%",cost:[2100,6300,18900,56700,170100],success:[90,82,72,61,49]},
  luckCore:{icon:"🍀",slot:"LUCK",name:"행운 환급 코어",desc:"강화에 성공하면 실제로 지불한 강화 비용 일부를 즉시 돌려받습니다.",effect:"성공 비용 환급",unit:"+8%",cost:[3500,10500,31500,94500,283500],success:[86,76,64,52,40]},
  freezeMatrix:{icon:"🧊",slot:"STABLE",name:"단계 안정 매트릭스",desc:"기존 단계 안정제를 영구 파츠로 통합. 하락 확률 일부를 유지 확률로 바꿉니다.",effect:"하락 방어",unit:"12% 변환",cost:[3200,9600,28800,86400,259200],success:[92,83,74,63,53]},
  volatileCore:{icon:"💣",slot:"OUTPUT",name:"고출력 변이 코어",desc:"기존 변이 코어를 영구 파츠로 통합. 일반 강화 성공 시 일정 확률로 +1단계를 추가 획득합니다. 광폭 강화에는 적용되지 않습니다.",effect:"추가 상승",unit:"+6% 확률",cost:[4500,13500,40500,121500,364500],success:[84,73,61,49,37]},
  recoveryCatalyst:{icon:"💹",slot:"AUCTION",name:"경매 분석 모듈",desc:"경매 낙찰 데이터를 분석해 최종 낙찰 환급률을 직접 높입니다.",effect:"경매 낙찰 보정",unit:"+2%p",cost:[2600,7800,23400,70200,210600],success:[91,84,75,64,50]},
  frenzyInjector:{icon:"🔥",slot:"INJECT",name:"폭주 연장 인젝터",desc:"냄새 폭주 이벤트가 발동할 때 일정 확률로 효과 지속 횟수를 1회 추가합니다.",effect:"폭주 지속 연장",unit:"+25% 확률",cost:[3000,9000,27000,81000,243000],success:[85,74,63,51,39]},
  berserkAmplifier:{icon:"☢️",slot:"BERSERK",name:"광폭 증폭 코어",desc:"광폭 강화 성공 시 일정 확률로 최종 상승 단계에 +1단계를 추가합니다. 일반 강화에는 적용되지 않습니다.",effect:"광폭 추가 상승",unit:"+6% 확률",cost:[3800,11400,34200,102600,307800],success:[86,75,64,52,41]}
};
...
function normalizeStorageSlots(input){
  const src=Array.isArray(input)?input:[];
  return Array.from({length:6},(_,i)=>{
    const v=src[i];
    if(!v||!Number(v.level))return null;
    return {level:Math.max(1,Math.min(MAX_LEVEL,Number(v.level)||1)),storedAt:Number(v.storedAt)||Date.now(),warpSaleLock:Math.max(0,Math.min(2,Number(v.warpSaleLock)||0))};
  });
}
function normalizeFusionLinks(input,research={}){
  const src=Array.isArray(input)?input:[],used=new Set(),out=[];
  for(const raw of src){
    const a=String(raw?.a||''),b=String(raw?.b||'');
    if(!RESEARCH_DATA[a]||!RESEARCH_DATA[b]||a===b||used.has(a)||used.has(b))continue;
    if((Number(research?.[a])||0)<CORE_FUSION_MIN_LEVEL||(Number(research?.[b])||0)<CORE_FUSION_MIN_LEVEL)continue;
    const boost=Math.max(.12,Math.min(.30,Number(raw?.boost)||.12));
    const grade=String(raw?.grade||'STABLE');
    const parsedCost=Number(raw?.cost);
    const cost=Math.max(0,Math.floor(Number.isFinite(parsedCost)?parsedCost:CORE_FUSION_COST));
    out.push({a,b,boost,grade,cost,createdAt:Number(raw?.createdAt)||Date.now()});
...
const INITIAL = {
  schemaVersion:36,
  enhanceAttempts:0,warpUses:0,sellCount:0,auctionCount:0,finalClears:0,frenzyTriggers:0,
  storageCount:0,storageSlots:normalizeStorageSlots(),
  ...
  runData:{level:0,prev_level:0,max_level:0,money:"100000",status:"READY",shield:0,combo:0,best_combo:0,last_aux_effect:"",research:emptyResearch(),equippedParts:[],fusionLinks:[],frenzyGauge:0,frenzyEvent:null,warpBoostLevel:0,warpSaleLock:0,
    unlocked_warps:Object.fromEntries(WARP_LEVELS.map(w=>[w,false]))}
};

let state = loadState();
state.storageSlots=normalizeStorageSlots(state.storageSlots);
applyUserQualitySettings();
let toastTimer = null;
let actionLocked = false;
let currentGameView = "enhance";
let selectedLabPartKey = Object.keys(RESEARCH_DATA)[0] || "catalyst";
let fusionSelectedKeys=[];
let fusionGaugeRunning=false;
let fusionGaugePosition=0;
let fusionGaugeStartedAt=0;
let fusionGaugeRaf=0;
let fusionLastResult=null;
let currentLabSubView='upgrade';
let devMode = false;
let delPressCount = 0;
...
function normalizeRunData(d){
  ...
  out.unlocked_warps=Object.fromEntries(WARP_LEVELS.map(w=>[w,!!out.unlocked_warps?.[w]]));
  ...
  out.max_level=Math.max(out.level,Math.min(MAX_LEVEL,Number(out.max_level)||0)); for(const w of WARP_LEVELS) if(out.max_level>=w||out.level>=w) out.unlocked_warps[w]=true; out.shield=Math.max(0,Math.min(SHIELD_MAX,Number(out.shield)||0));
  delete out.tears; delete out.pity_count; delete out.feverFree; delete out.reviveTickets; delete out.stageChoices;
  ...
  out.equippedParts=[...new Set((requested||[]).filter(key=>RESEARCH_DATA[key]&&out.research[key]>0))];
  out.fusionLinks=normalizeFusionLinks(out.fusionLinks,out.research);
  delete out.labPresets;
  delete out.labPresetNames;
  ...
  out.warpSaleLock=Math.max(0,Math.min(2,Number(out.warpSaleLock)||0));
  out.warpBoostLevel=Math.max(0,Math.min(RESEARCH_MAX*1.5,Number(out.warpBoostLevel)||0));
  if(out.level===0){out.warpBoostLevel=0;out.warpSaleLock=0;}
...
function scaleLegacyMoney(rawMoney,lvl){
  ...
  if(old<=0n)return 100000n;
  if(oldPrice<=0n)return old>100000n?old:100000n;
...
function cleanRemovedSystems(s){
  ...
  delete s.raid;
  delete s.investor; delete s.investorContracts; delete s.investorWins;
  if(s.runData){delete s.runData.pity_count;delete s.runData.feverFree;delete s.runData.labPresets;delete s.runData.labPresetNames;}
  return s;
}
function loadState(){
  try{
    ...
    if(saved.schemaVersion>=15&&saved.runData){
      const s=Object.assign(clone(INITIAL),saved);s.runData=normalizeRunData(saved.runData);s.uiSettings=normalizeUiSettings(saved.uiSettings);s.schemaVersion=36;
    ...
    if(saved.schemaVersion>=13&&saved.runData){
      ...
      s.schemaVersion=36;return cleanRemovedSystems(s);
    }
...
function comboSuccessBoost(v=combo()){const c=Math.max(0,Number(v)||0);return c>=15?6:c>=7?2.5:0;}
function comboCriticalBoost(v=combo()){const c=Math.max(0,Number(v)||0);return c>=15?.11:c>=10?.07:c>=5?.04:0;}
function comboCostDiscount(v=combo()){const c=Math.max(0,Number(v)||0);return c>=15?18:c>=10?12:c>=5?6:0;}
function comboDestroyProtection(v=combo(), destroyChance=null){
  const c=Math.max(0,Number(v)||0);
  const reduction=c>=15?9:c>=10?6:0;
...
function fusionLinkForCore(key,d=state.runData){return (Array.isArray(d?.fusionLinks)?d.fusionLinks:[]).find(link=>link?.a===key||link?.b===key)||null;}
function fusionBonusForCore(key,d=state.runData){const link=fusionLinkForCore(key,d);return link?Math.max(0,Math.min(.30,Number(link.boost)||0)):0;}
function activeResearchPower(key,d=state.runData){const lv=activeResearchLevel(key,d);return lv>0?lv*(1+fusionBonusForCore(key,d)):0;}
function equippedPartCount(d=state.runData){return equippedResearchKeys(d).length;}
function researchCost(key,d=state.runData){const lv=researchLevel(key,d),cfg=RESEARCH_DATA[key];if(!cfg||lv>=RESEARCH_MAX)return null;const base=Number(cfg.cost[lv]||0);return Math.ceil(base*LAB_COST_MULTIPLIER/100)*100;}
function labUpgradeOdds(key,lv=researchLevel(key)){const cfg=RESEARCH_DATA[key],idx=Math.max(0,Math.min(RESEARCH_MAX-1,Number(lv)||0));const success=Math.max(0,Math.min(100,Number(cfg?.success?.[idx]??100)));return {success,hold:100-success};}
function labUpgradeOddsText(key,lv=researchLevel(key)){const o=labUpgradeOdds(key,lv);return `성공 ${o.success}% · 유지 ${o.hold}%`;}
function labUpgradeScheduleText(key){const cfg=RESEARCH_DATA[key];if(!cfg)return '';return cfg.success.map((v,i)=>`Lv.${i+1} ${v}%/${100-v}%`).join(' · ');}
...
function stagePointMultiplier(d=state.runData){return (1+activeResearchPower('insight',d)*.07)*(frenzyEventIs('points',d)?2:1);}
...
function criticalRateFor(d=state.runData,lvl=level()){
  ...
  let r=CRITICAL_RATE+activeResearchPower('precision',d)*.017;
...
function baseEnhanceCost(lvl){ return toMoneyInt(ENHANCE_COST[Number(lvl)] ?? ENHANCE_COST[MAX_LEVEL-1]); }
...
function effectiveEnhanceCost(mode="normal",d=state.runData){
  ...
  const economy10=Math.max(0,Math.round((100-activeResearchPower('economy',d)*3.5)*10));
  cost=(cost*BigInt(economy10)+999n)/1000n;
...
function playerEnhanceCost(mode='normal',d=state.runData){ return effectiveEnhanceCost(mode,d); }
function researchDiscountPercent(key,perLevel,d=state.runData){return Math.max(0,100-activeResearchPower(key,d)*perLevel);}
...
function shieldPointCost(lvl,d=state.runData,shieldLv=activeResearchPower('shieldTech',d)){
  const pct=Math.max(0,100-Math.max(0,Number(shieldLv)||0)*7);
  return Math.max(1,Math.round(pointReward(lvl)*1.5*pct/100));
}
function shieldMoneyCost(lvl,d=state.runData,shieldLv=activeResearchPower('shieldTech',d)){
  const scaled=(baseEnhanceCost(lvl)*75n+99n)/100n,base=scaled>10000n?scaled:10000n;
  const pct10=Math.max(0,Math.round((100-Math.max(0,Number(shieldLv)||0)*7)*10));
  return (base*BigInt(pct10)+999n)/1000n;
}
...
function effectiveProbabilities(base,opts={}){
  ...
  shiftToSuccess(activeResearchPower('catalyst',d)*.8);
  const warpBoost=Math.max(0,Number(d.warpBoostLevel)||0)*2.2;if(warpBoost>0)shiftToSuccess(warpBoost);
  const freezeRate=activeResearchPower('freezeMatrix',d)*.12;if(freezeRate>0&&down>0){const moved=down*freezeRate;down-=moved;hold+=moved;}
  const safety=activeResearchPower('safety',d)*.9;if(safety>0){const moved=Math.min(destroy,safety);destroy-=moved;hold+=moved;}
...
function activateRandomFrenzyEvent(d=state.runData){
  ...
  const extendChance=Math.min(1,activeResearchPower('frenzyInjector',d)*.25);
  const extended=extendChance>0&&Math.random()<extendChance;
  const turns=cfg.turns+(extended?1:0),desc=cfg.desc+(extended?' · 인젝터 연장 +1회':'');
  d.frenzyEvent={type,turns,label:cfg.label,desc};
  return {type,label:cfg.label,desc,turns,instant:false};
}
...
function frenzyChargeForStatus(status,d=state.runData){
  ...
  const chargeMult=1+activeResearchPower('capacitor',d)*.12;
...
function syncActionButtons(){
  const l=level(),eb=document.getElementById("enhanceBtn"),sb=document.getElementById("sellBtn"),ab=document.getElementById("auctionBtn"),bb=document.getElementById("berserkBtn");
  if(eb){
    eb.disabled=actionLocked||l>=MAX_LEVEL;
    eb.classList.remove('final-holding','final-hold-complete');
    eb.classList.toggle('final-hold-ready',l===MAX_LEVEL-1&&!actionLocked);
    eb.textContent=l>=MAX_LEVEL?'55단계 MAX':'강화하기';
  }
  const warpSaleLocked=Math.max(0,Number(state.runData.warpSaleLock)||0)>0;
  if(sb){sb.disabled=actionLocked||l===0||warpSaleLocked;sb.textContent='판매하기';}
  if(ab){
    const auctionAvailable=l>=10;
    ab.disabled=actionLocked||!auctionAvailable||warpSaleLocked;
    ab.textContent=l<10?'🎯 경매하기 · 10단계 해금':'🎯 경매하기';
  }
  const ai=document.getElementById('auctionInfo');
  if(ai){
    const auctionPower=activeResearchPower('recoveryCatalyst',state.runData),auctionBoost=Math.round(auctionPower*2);
    if(l<10) ai.textContent='10단계부터 사용 가능 · 낙찰 환급률에 따라 판매 금액이 결정됩니다.';
    else if(warpSaleLocked) ai.textContent=`워프 후 강화 시도를 ${Math.max(0,Number(state.runData.warpSaleLock)||0)}회 더 해야 경매할 수 있습니다.`;
    else ai.innerHTML=`10~55단계 사용 가능 · 랜덤 낙찰 환급률${auctionBoost?` · <b>💹 연구소 +${auctionBoost}%p</b>`:''}`;
  }
  if(bb){
    const available=l>=20&&l<=45;
    bb.disabled=actionLocked||!available;
    bb.textContent=l<20?'☠️ 광폭 강화 · 20단계 해금':l>45?'☠️ 광폭 강화 · 20~45단계 전용':`☠️ 광폭 강화 · ${formatGold(playerEnhanceCost('berserk'))}`;
  }
  ...
  if(bi){
    ...
    else if(l>45) bi.textContent='20~45단계에서만 사용 가능 · 성공 시 +2~6단계 랜덤 상승';
    else{
      const raw=PROB[String(l)]||[8,40,47,5];
      const bp=effectiveProbabilities(raw,{mode:'berserk'}),berserkAmp=activeResearchPower('berserkAmplifier',state.runData),ampChance=Math.min(100,Math.round(berserkAmp*6));
      bi.innerHTML=`<b class="berserk-success-rate">성공 ${bp[0]}%</b> · <b class="berserk-destroy-rate">파괴 ${bp[2]}%</b> · 성공 시 <strong>+2~6단계 랜덤 상승</strong>${ampChance?` · <b class="berserk-amp-rate">☢️ 추가 +1 ${ampChance}%</b>`:''}`;
    }
  }
...
function registerEnhanceFailure(d){
  const lv=activeResearchPower('resale',d),chance=lv*.14;
...
function unlockReachedWarps(d=state.runData){for(const w of WARP_LEVELS)if(d.max_level>=w||d.level>=w)d.unlocked_warps[w]=true;}
...
function cleanupTransientEffects(){
  ...
  document.querySelectorAll('.berserk-roulette-overlay,.auction-roulette-overlay,.card-draw-overlay,.frenzy-event-overlay,.result-fx-layer,.destruction-shard,.destruction-void-ring').forEach(e=>e.remove());
  pruneCardParticles();
}
...
function showCardDrawReveal(lvl,done=()=>{}){
  // 신규 최고 단계 카드 획득 연출 제거: 후속 강화 흐름을 즉시 계속한다.
  done();
}
...
function enhance(mode="normal"){
  ...
  if(curr===MAX_LEVEL-1&&mode==='normal'&&!finalHoldAuthorized){showToast('54→55 강화는 강화하기 버튼을 끝까지 꾹 눌러야 합니다.');return;}
  if(mode==='berserk'&&(curr<20||curr>45)){showToast('☠️ 광폭 강화는 20~45단계에서만 사용할 수 있습니다.');return;}
  const fullCost=effectiveEnhanceCost(mode,d),cost=fullCost;
  const paidAttempt=fullCost>0n,warpBoostAtStart=Math.max(0,Number(d.warpBoostLevel)||0);
  ...
  if(Number(d.warpSaleLock)>0)d.warpSaleLock=Math.max(0,Number(d.warpSaleLock)-1);
  ...
  const successResult=(baseAdd=1,status="SUCCESS",isCritical=false)=>{
    let add=baseAdd;
    if(mode==='berserk'){
      add=2+Math.floor(Math.random()*5);
      const berserkAmp=activeResearchPower('berserkAmplifier',d);
      if(berserkAmp>0&&Math.random()<Math.min(1,berserkAmp*.06)&&d.level+add<MAX_LEVEL){add+=1;appendAuxEffect('☢️ 광폭 증폭 · 추가 +1단계');}
      berserkGain=add;appendAuxEffect(`☠️ 광폭 +${add}단계`);
    }
    if(frenzyEventBefore?.type==='surge'&&d.level+add<MAX_LEVEL){add+=1;appendAuxEffect('🚀 폭주 추진 추가 +1단계');}
    const volatileLv=activeResearchPower('volatileCore',d);
    if(mode==='normal'&&volatileLv>0&&Math.random()<volatileLv*.06&&d.level+add<MAX_LEVEL){
    ...
    let mult=registerEnhanceSuccess(d);
  ...
  const destroyResult=()=>{
    if(d.shield>0){
      const preserveChance=activeResearchPower('fusion',d)*.12,preserved=preserveChance>0&&Math.random()<preserveChance;
      if(!preserved)d.shield--;
      d.status="SHIELD_SAVED";state.enhanceFailures++;
      if(preserved)appendAuxEffect('🧪 실드 순환 · 방지권 보존');
      appendAuxEffect(mode==='berserk'?'☠️ 광폭 폭발 · 방지권 생존':'');
    }
  ...
  if(['SUCCESS','CRITICAL'].includes(d.status)&&cost>0n){
    const refundPct=activeResearchPower('luckCore',d)*8;
    if(refundPct>0){
      const refund10=Math.max(0,Math.round(refundPct*10));
      const refund=(cost*BigInt(refund10)+999n)/1000n;
      if(refund>0n){setMoney(money()+refund);appendAuxEffect(`🍀 행운 환급 +${formatGold(refund)}`);}
    }
  }
  if(paidAttempt&&warpBoostAtStart>0)d.warpBoostLevel=0;
  if(d.level===0){d.warpBoostLevel=0;d.warpSaleLock=0;}
...
function finishNormalSale(l,price){
  const d=state.runData;
  setMoney(money()+price);state.sellCount++;
  d.prev_level=l;d.level=0;d.status="READY";d.last_aux_effect="";d.warpBoostLevel=0;d.warpSaleLock=0;resetCombo(d);
  save();render();setActionLocked(false);
  showToast(`💰 ${l}단계 판매 완료! +${formatGold(price)}`);
}
function showSellAnimation(l,price,done=()=>{}){
  const card=document.getElementById('enhanceCard');
  ...
  if(!card||!motion){setTimeout(done,120);return;}

  document.querySelectorAll('.sell-fx-overlay').forEach(e=>e.remove());
  gsap.killTweensOf([motion,glow,priceEl]);
  if(typeof window.jionCardTiltSettle==='function')window.jionCardTiltSettle();
  scene?.classList.add('status-sold');
  result?.classList.add('sell-result-live');
  if(result)result.textContent='SOLD';

  const finish=()=>{
    gsap.set(motion,{x:0,y:0,rotation:0,scale:1,opacity:1,filter:'none'});
    scene?.classList.remove('status-sold');
    result?.classList.remove('sell-result-live');
    done();
  };
  if(motionMode==='low'||JION_PERF.reduced){
    cardBurst('#facc15',12,95);impactFlash(.12);
    card.animate?.([{transform:'scale(1)'},{transform:'scale(1.025)'},{transform:'scale(1)'}],{duration:260,easing:'ease-out'});
    setTimeout(finish,280);return;
  }

  const tl=gsap.timeline({defaults:{overwrite:'auto'},onComplete:finish});
  tl.to(motion,{y:7,scale:.982,rotation:-.7,duration:.09,ease:'power2.in'})
    .add(()=>{
      cardBurst('#facc15',motionMode==='medium'?34:54,170);
      impactFlash(.25);
      if(glow)gsap.fromTo(glow,{scale:.80,opacity:.10,background:'#facc15'},{scale:1.58,opacity:.48,duration:.20,yoyo:true,repeat:1,ease:'power2.out'});
      if(priceEl)gsap.fromTo(priceEl,{scale:.98,filter:'brightness(1)'},{scale:1.18,filter:'brightness(1.35)',duration:.14,yoyo:true,repeat:1,ease:'power2.out'});
    })
    .to(motion,{y:-18,scale:1.045,rotation:.8,duration:.16,ease:'back.out(1.7)'})
    .add(()=>{
      cardBurst('#fde68a',motionMode==='medium'?14:24,105);
      impactFlash(.10);
    },'-=.05')
    .to(motion,{y:3,scale:.998,rotation:-.25,duration:.10,ease:'power2.inOut'})
    .to(motion,{y:0,scale:1,rotation:0,duration:.20,ease:'power2.out'});
}
function sell(){
  if(actionLocked)return;
  const d=state.runData,l=d.level;if(l===0)return;
  if(Number(d.warpSaleLock)>0){showToast(`🚀 워프 후 강화 시도를 ${Number(d.warpSaleLock)}회 더 해야 판매할 수 있습니다.`);return;}
  const basePrice=dbPrice(l),price=basePrice*BigInt(stageSellPercent(d))/100n;
  setActionLocked(true);
  showSellAnimation(l,price,()=>finishNormalSale(l,price));
}

/* --------------------------- AUCTION ROULETTE ---------------------------
   Normal sell and auction are intentionally separate systems.
   Auction rolls one of six equally-likely refund multipliers against the
   current card's displayed expected value, then automatically completes sale. */
const AUCTION_MULTIPLIERS=Object.freeze([50,70,90,110,130,150]);
function finishAuctionSale(l,price,pct){
  const d=state.runData;
  setMoney(money()+price);
  state.auctionCount=Math.max(0,Number(state.auctionCount)||0)+1;
  d.prev_level=l;d.level=0;d.status="READY";d.last_aux_effect="";d.warpBoostLevel=0;d.warpSaleLock=0;resetCombo(d);
  save();render();setActionLocked(false);
  showToast(`${l}단계 경매 낙찰 · ${pct}% 환급! +${formatGold(price)}`);
}
function showAuctionRoulette(l,basePrice,basePct,pct,price,done=()=>{}){
  const motion=motionPreset();
  if(motion==='low'||JION_PERF.reduced){requestAnimationFrame(done);return;}
  document.querySelectorAll('.auction-roulette-overlay').forEach(e=>e.remove());
  const resultIndex=Math.max(0,AUCTION_MULTIPLIERS.indexOf(basePct));
  const overlay=document.createElement('div');
  overlay.className='auction-roulette-overlay';
  const labels=AUCTION_MULTIPLIERS.map((v,i)=>`<span class="auction-wheel-label" style="--auction-a:${i*60}deg;--auction-na:${-i*60}deg"><b>${v}%</b></span>`).join('');
  overlay.innerHTML=`<div class="auction-fx-grid" aria-hidden="true"></div><div class="auction-fx-scan" aria-hidden="true"></div><div class="auction-bid-pulses" aria-hidden="true"><i></i><i></i><i></i><i></i><i></i><i></i></div><div class="auction-roulette-box">
    <small>JION AUCTION HOUSE</small>
    <div class="auction-roulette-kicker">LIVE ODOR AUCTION · BIDDING NOW</div>
    <div class="auction-bid-ticker"><span>● LIVE</span><b>입찰 신호 수신 중</b><i>₩</i></div>
    <div class="auction-wheel-shell">
      <div class="auction-wheel-pointer" aria-hidden="true"></div>
      <div class="auction-wheel" id="auctionWheel">${labels}</div>
      <div class="auction-wheel-hub">₩</div>
    </div>
    <div class="auction-roulette-range">50% · 70% · 90% · 110% · 130% · 150%</div>
    <b class="auction-roulette-result">입찰가 산정 중...</b>
    <div class="auction-payout-copy"><span>예상가치 ${formatGold(basePrice)}</span><strong>룰렛 결과 대기</strong></div>
  </div>`;
  document.body.appendChild(overlay);
  const wheel=overlay.querySelector('#auctionWheel');
  const result=overlay.querySelector('.auction-roulette-result');
  const payout=overlay.querySelector('.auction-payout-copy');
  const payoutStrong=payout?.querySelector('strong');
  requestAnimationFrame(()=>{
    overlay.classList.add('show');
    overlay.classList.add('scanning');
    requestAnimationFrame(()=>{
      const spins=motion==='medium'?5:9;
      const target=spins*360-resultIndex*60;
      wheel.style.transitionDuration=motion==='medium'?'1.65s':'3.15s';
      wheel.style.transform=`rotate(${target}deg)`;
    });
  });
  const spinMs=motion==='medium'?1730:3260;
  setTimeout(()=>{
    if(!overlay.isConnected){done();return;}
    overlay.classList.remove('scanning');
    overlay.classList.add('locked','hammer-hit');
    if(pct>=130)overlay.classList.add('jackpot');
    else if(pct<=70)overlay.classList.add('low-result');
    else if(pct>=110)overlay.classList.add('profit-result');
    result.textContent=`🔨 낙찰 확정 · ${pct}%`;
    if(payoutStrong)payoutStrong.textContent=`${pct}% → ${formatGold(price)}`;
    payout.classList.add('show-result');
    const burstColor=pct>=130?'#facc15':pct>=110?'#34d399':pct<=70?'#fb7185':'#60a5fa';
    cardBurst(burstColor,pct>=150?210:135,pct>=150?380:280);impactFlash(pct>=150?.68:.42);document.body.classList.add('auction-screen-hit');setTimeout(()=>document.body.classList.remove('auction-screen-hit'),360);
    setTimeout(()=>{
      overlay.classList.remove('show');
      setTimeout(()=>{overlay.remove();done();},motion==='medium'?120:190);
    },motion==='medium'?720:1050);
  },spinMs);
}
function auction(){
  if(actionLocked)return;
  const d=state.runData,l=d.level;if(l<10){showToast('🎯 경매는 10단계부터 사용할 수 있습니다.');return;}
  if(Number(d.warpSaleLock)>0){showToast(`🚀 워프 후 강화 시도를 ${Number(d.warpSaleLock)}회 더 해야 경매할 수 있습니다.`);return;}
  const basePrice=dbPrice(l);
  const basePct=AUCTION_MULTIPLIERS[Math.floor(Math.random()*AUCTION_MULTIPLIERS.length)];
  const auctionBoost=Math.max(0,Math.round(activeResearchPower('recoveryCatalyst',d)*2));
  const pct=Math.min(175,basePct+auctionBoost);
  const price=basePrice*BigInt(pct)/100n;
  setActionLocked(true);
  showAuctionRoulette(l,basePrice,basePct,pct,price,()=>finishAuctionSale(l,price,pct));
}
...
function render(){
  ...
  if(currentGameView==='storage')renderStorageView();
  ...
  if(comboLabel)comboLabel.textContent='🔥 연속 콤보';if(auxLabel)auxLabel.textContent='🔬 연구 효과';
  ...
  const modBar=document.getElementById('runModifierBar');if(modBar){const tags=[];const ev=currentFrenzyEvent(sd);if(ev)tags.push(`🔥 ${ev.label.replace(/^\S+\s*/,'')} ${ev.turns}회`);if(Number(sd.warpBoostLevel)>0)tags.push(`🧭 워프 보정 · 다음 유료 강화 성공 +${(Number(sd.warpBoostLevel)*2.2).toFixed(1)}%p`);if(Number(sd.warpSaleLock)>0)tags.push(`🚀 워프 판매 잠금 · 강화 시도 ${2-Number(sd.warpSaleLock)}/2회`);modBar.innerHTML=tags.map(t=>`<span>${t}</span>`).join('');modBar.classList.toggle('hidden',!tags.length);}
  const activeEl=document.getElementById("auxActive"),activeHint=document.getElementById("auxHint"),equippedCount=equippedPartCount(sd);if(activeEl)activeEl.textContent=`${equippedCount}개 적용`;if(activeHint){activeHint.textContent='보유 파츠 자유 장착';activeHint.classList.remove('hidden');}
  ...
  const rawP=l>=MAX_LEVEL?[100,0,0,0]:(PROB[String(l)]||[8,40,47,5]),p=effectiveProbabilities(rawP,{data:sd}),comboGuardNow=comboDestroyProtection(sd.combo, rawP[2]),comboSuccessNow=comboSuccessBoost(sd.combo),comboProbNote=(comboGuardNow>0||comboSuccessNow>0)?`<div class="prob-aux combo-guard-note">🔥 콤보 효과${comboSuccessNow?` · 성공 +${comboSuccessNow}%p`:''}${comboGuardNow?` · 파괴 -${comboGuardNow}%p`:''}</div>`:'',labNotes=[],catalystLv=activeResearchPower('catalyst',sd),freezeLv=activeResearchPower('freezeMatrix',sd);if(catalystLv)labNotes.push(`🧬 성공 +${(catalystLv*.8).toFixed(1)}%p`);if(freezeLv)labNotes.push(`🧊 하락 ${Math.round(freezeLv*12)}% 유지 전환`);if(Number(sd.warpBoostLevel)>0)labNotes.push(`🧭 워프 보정 성공 +${(Number(sd.warpBoostLevel)*2.2).toFixed(1)}%p`);const auxProbNote=labNotes.length?`<div class="prob-aux">${labNotes.join(' · ')}</div>`:"",critPct=Math.round(criticalRateFor(sd,l)*1000)/10,critCopy=l>=50?'✦ 50단계 이후 크리티컬 비활성':'✦ 성공 시 크리티컬 확률';
  ...
  const sb=document.getElementById("sellBtn");if(sb)sb.textContent="판매하기";const ab=document.getElementById("auctionBtn");if(ab)ab.textContent="경매하기";syncActionButtons();renderSceneText();renderEnhanceCard();
}
function renderSceneText(){
  ...
  document.getElementById("costText").textContent=l>=MAX_LEVEL?"강화 완료 · MAX STAGE 55":"필요 강화 비용: "+(playerEnhanceCost("normal")===0n?"무료":formatGold(playerEnhanceCost("normal")));
...
function renderEnhanceCard(){
  ...
  document.getElementById('cardPrice').textContent=formatGold(dbPrice(l));document.getElementById('cardPoints').textContent=pointReward(l).toLocaleString('ko-KR')+'P';document.getElementById('cardCost').textContent=l>=MAX_LEVEL?'MAX':(playerEnhanceCost('normal')===0n?'무료':formatGold(playerEnhanceCost('normal')));
...
function shopHTML(){
  const l=level(),sh=shield(),moneyCost=shieldMoneyCost(l),pointCost=shieldPointCost(l),minShield=15,d=state.runData,warpLevels=WARP_LEVELS;
  ...
  return `<div class="shop-wallet shop-wallet-compact"><div class="wallet-card money"><small>보유 금액</small><b>${formatGold(money())}</b></div><div class="wallet-card point"><small>보유 포인트</small><b>${state.points.toLocaleString('ko-KR')}P</b></div></div><div class="modal-section shop-section shield-section"><div class="section-heading"><div><span>🛡️</span><div><small>PROTECTION</small><h3>파괴 방지권</h3></div></div><b>${sh} / ${SHIELD_MAX}</b></div><p class="section-copy">파괴 결과를 한 번 막아주는 안전장치입니다. ${minShield}단계부터 구매할 수 있습니다.</p><div class="shield-price-grid"><div><small>💰 돈 가격</small><b>${formatGold(moneyCost)}</b></div><div><small>⭐ 포인트 가격</small><b>${pointCost.toLocaleString('ko-KR')}P</b></div></div><div class="warp-actions"><button class="glass-btn money-buy" data-buy-shield="money" ${(l<minShield||sh>=SHIELD_MAX||money()<moneyCost)?'disabled':''}>💰 돈으로 구매</button><button class="glass-btn point-buy" data-buy-shield="point" ${(l<minShield||sh>=SHIELD_MAX||state.points<pointCost)?'disabled':''}>⭐ 포인트로 구매</button></div></div><div class="modal-section shop-section warp-section"><div class="section-heading"><div><span>🚀</span><div><small>STAGE WARP</small><h3>워프권</h3></div></div><b>${l}단계</b></div><p class="section-copy">한 번 도달했던 주요 체크포인트로 즉시 이동합니다. 워프 직후에는 판매·경매가 잠기며, 일반 강화하기 버튼을 2회 눌러야 잠금이 해제됩니다.</p><div class="warp-list">${warps}</div></div>`;
}
...
function researchEffectValueText(key,lv){
  const n=Math.max(0,Math.min(RESEARCH_MAX,Number(lv)||0));
  if(key==='catalyst')return `성공 확률 +${(n*.8).toFixed(1)}%p`;
  if(key==='safety')return `파괴 확률 -${(n*.9).toFixed(1)}%p`;
  if(key==='economy')return `강화 비용 -${(n*3.5).toFixed(1).replace('.0','')}%`;
  if(key==='insight')return `성공 포인트 +${n*7}%`;
  if(key==='resale')return `콤보 보존 ${n*14}%`;
  if(key==='capacitor')return `폭주 충전 +${n*12}%`;
  if(key==='precision')return `크리티컬 +${(n*1.7).toFixed(1)}%p`;
  if(key==='shieldTech')return `방지권 가격 -${n*7}%`;
  if(key==='warpTech')return `워프 후 성공 +${(n*2.2).toFixed(1)}%p`;
  if(key==='fusion')return `방지권 보존 ${n*12}%`;
  if(key==='luckCore')return `성공 시 강화비 환급 ${n*8}%`;
  if(key==='freezeMatrix')return `하락→유지 변환 ${n*12}%`;
  if(key==='volatileCore')return `추가 +1단계 발동 ${n*6}%`;
  if(key==='recoveryCatalyst')return `경매 낙찰 환급률 +${(n*2).toFixed(1).replace('.0','')}%p`;
  if(key==='frenzyInjector')return `폭주 지속 +1회 확률 ${Math.min(100,n*25)}%`;
  if(key==='berserkAmplifier')return `광폭 성공 추가 +1단계 확률 ${Math.min(100,n*6)}%`;
  return `Lv.${n}`;
}
function researchDeltaText(key,lv){
  const n=Math.max(0,Math.min(RESEARCH_MAX,Number(lv)||0));
  const current=n===0?'현재 효과 없음':`현재 ${researchEffectValueText(key,n)}`;
  if(n>=RESEARCH_MAX)return `${current} · MAX`;
  return `${current} → Lv.${n+1} ${researchEffectValueText(key,n+1)}`;
}
function labCorePickerHTML(){
  const d=state.runData;
  return Object.entries(RESEARCH_DATA).map(([key,cfg])=>{
    const lv=researchLevel(key,d),selected=key===selectedLabPartKey,equipped=isResearchEquipped(key,d),fusionLink=fusionLinkForCore(key,d),fusionBoost=fusionBonusForCore(key,d);
    return `<button class="lab-core-choice ${selected?'selected':''} ${lv>0?'owned':''} ${equipped?'equipped':''} ${lv>=RESEARCH_MAX?'maxed':''} ${fusionLink?'fusion-linked':''}" type="button" data-lab-select="${key}">
      <span class="lab-core-choice-icon">${cfg.icon}</span>
      <span class="lab-core-choice-copy"><small>${cfg.slot}</small><b>${cfg.name}</b><span class="lab-core-choice-desc">${cfg.desc}</span><span class="lab-core-choice-effect">${researchDeltaText(key,lv)}${fusionLink?` · 🔬 융합 +${Math.round(fusionBoost*100)}%`:''}</span><span class="lab-core-choice-chance">${lv>=RESEARCH_MAX?'강화 완료':`다음 강화 · ${labUpgradeOddsText(key,lv)}`}</span></span>
      <span class="lab-core-choice-level">Lv.${lv}</span>
    </button>`;
  }).join('');
}
function renderLabView(){
  const picker=document.getElementById('labCorePicker');if(!picker)return;
  if(!RESEARCH_DATA[selectedLabPartKey])selectedLabPartKey=Object.keys(RESEARCH_DATA)[0];
  const d=state.runData,key=selectedLabPartKey,cfg=RESEARCH_DATA[key],lv=researchLevel(key,d),cost=researchCost(key,d),maxed=lv>=RESEARCH_MAX,equipped=isResearchEquipped(key,d);
  const wallet=document.getElementById('labPointWallet');if(wallet)wallet.textContent=state.points.toLocaleString('ko-KR')+'P';
  picker.innerHTML=labCorePickerHTML();
  const icon=document.getElementById('labUpgradeIcon'),slot=document.getElementById('labSelectedSlot'),name=document.getElementById('labSelectedName'),desc=document.getElementById('labSelectedDesc'),metric=document.getElementById('labSelectedMetric');
  if(icon)icon.textContent=cfg.icon;if(slot)slot.textContent=`${cfg.slot} PART · ${cfg.effect}`;if(name)name.textContent=cfg.name;if(desc)desc.textContent=cfg.desc;if(metric){const fusionBoost=fusionBonusForCore(key,d);metric.innerHTML=`<b>${researchDeltaText(key,lv)}</b>${fusionBoost?`<span class="lab-fusion-metric">🔬 융합 공명 · 장착 효과 +${Math.round(fusionBoost*100)}%</span>`:''}${maxed?'':`<span class="lab-next-odds">다음 강화 · ${labUpgradeOddsText(key,lv)}</span>`}<span class="lab-prob-schedule">강화 확률표 · ${labUpgradeScheduleText(key)}</span>`;}
  const levels=document.getElementById('labSelectedLevels');if(levels)levels.innerHTML=Array.from({length:RESEARCH_MAX},(_,i)=>`<i class="${i<lv?'on':''}"><span>${i+1}</span></i>`).join('');
  const costEl=document.getElementById('labUpgradeCost'),costHint=document.getElementById('labUpgradeCostHint');
  if(costEl)costEl.textContent=maxed?'MAX':`${Number(cost||0).toLocaleString('ko-KR')}P`;
  if(costHint)costHint.textContent=maxed?'최대 Lv.5 강화 완료':state.points<(cost||0)?'포인트가 부족합니다':`기존 대비 +15% · 보유 ${state.points.toLocaleString('ko-KR')}P`;
  const btn=document.getElementById('labUpgradeBtn');if(btn){btn.disabled=actionLocked||maxed||state.points<(cost||0);btn.textContent=maxed?'✅ Lv.5 MAX':lv===0?`⭐ 코어 획득 · Lv.1 강화 (${labUpgradeOddsText(key,lv)})`:`⭐ Lv.${lv+1} 강화 (${labUpgradeOddsText(key,lv)})`;}
  const equipBtn=document.getElementById('labEquipBtn');if(equipBtn){equipBtn.disabled=actionLocked||lv<=0;equipBtn.classList.toggle('is-equipped',equipped);equipBtn.textContent=lv<=0?'강화 후 자동 장착':equipped?'장착 해제':'장착하기';}
  const status=document.getElementById('labUpgradeStatus');if(status&&!document.getElementById('labUpgradeStage')?.classList.contains('upgrading'))status.textContent=maxed?'MAX LEVEL':`${cfg.name} · ${labUpgradeOddsText(key,lv)} · 성공 시 Lv.${lv+1}, 유지 시 Lv.${lv}`;
  renderLabFusion();
  bindLabButtons();
  bindLabSubTabs();
  syncLabSubView();
}
function spawnLabUpgradeParticles(icon='✦'){
  const box=document.getElementById('labUpgradeParticles');if(!box)return;
  box.innerHTML='';
  if(motionPreset()==='low'||JION_PERF.reduced)return;
  const count=JION_PERF.mobile?12:24,frag=document.createDocumentFragment();
  for(let i=0;i<count;i++){
    const p=document.createElement('i');p.textContent=i%5===0?icon:'✦';
    const a=(Math.PI*2*i/count)+(Math.random()*.28-.14),dist=70+Math.random()*(JION_PERF.mobile?70:130);
    p.style.setProperty('--px',`${Math.cos(a)*dist}px`);p.style.setProperty('--py',`${Math.sin(a)*dist}px`);p.style.setProperty('--pd',`${.48+Math.random()*.38}s`);p.style.setProperty('--ps',`${.7+Math.random()*.9}`);frag.appendChild(p);
  }
  box.appendChild(frag);
}
function playLabUpgradeAnimation(cfg,fromLv,toLv,success,done=()=>{}){
  const stage=document.getElementById('labUpgradeStage'),core=document.getElementById('labUpgradeCore'),levelUp=document.getElementById('labUpgradeLevelUp'),status=document.getElementById('labUpgradeStatus');
  if(!stage||!core){done();return;}
  const low=motionPreset()==='low'||JION_PERF.reduced,duration=low?260:(motionPreset()==='medium'?900:1350);
  stage.classList.remove('upgrade-success','upgrade-hold');void stage.offsetWidth;stage.classList.add('upgrading');
  core.dataset.icon=cfg.icon;if(status)status.textContent=`${cfg.name} 강화 판정 중...`;
  if(levelUp){levelUp.textContent=`Lv.${fromLv} → ?`;levelUp.classList.remove('show','hold');}
  spawnLabUpgradeParticles(success?cfg.icon:'◆');
  setTimeout(()=>{
    stage.classList.add(success?'upgrade-success':'upgrade-hold');
    if(levelUp){levelUp.textContent=success?`LEVEL UP · Lv.${toLv}`:`MAINTAIN · Lv.${fromLv}`;levelUp.classList.toggle('hold',!success);levelUp.classList.add('show');}
    if(status)status.textContent=success?`강화 성공 · ${cfg.name} Lv.${toLv}`:`강화 유지 · ${cfg.name} Lv.${fromLv}`;
  },Math.max(100,Math.round(duration*.54)));
  setTimeout(()=>{stage.classList.remove('upgrading','upgrade-success','upgrade-hold');if(levelUp)levelUp.classList.remove('show','hold');done();},duration);
}
function buyLabPart(key=selectedLabPartKey){
  if(actionLocked)return;
  const cfg=RESEARCH_DATA[key],d=state.runData;if(!cfg)return;
  selectedLabPartKey=key;d.research=Object.assign(emptyResearch(),d.research||{});d.equippedParts=Array.isArray(d.equippedParts)?d.equippedParts:[];
  const lv=researchLevel(key,d),cost=researchCost(key,d);
  if(lv>=RESEARCH_MAX||cost===null){showToast('이미 최대 Lv.5 강화 상태입니다.');return;}
  if(state.points<cost){showToast('포인트가 부족합니다.');return;}
  const odds=labUpgradeOdds(key,lv),success=Math.random()*100<odds.success;
  state.points-=cost;state.pointsSpentTotal+=cost;
  if(success){
    d.research[key]=lv+1;
    if(lv===0&&!d.equippedParts.includes(String(key)))d.equippedParts.push(String(key));
  }
  d.equippedParts=equippedResearchKeys(d);save();setActionLocked(true);
  const wallet=document.getElementById('labPointWallet');if(wallet)wallet.textContent=state.points.toLocaleString('ko-KR')+'P';
  const btn=document.getElementById('labUpgradeBtn');if(btn)btn.disabled=true;
  playLabUpgradeAnimation(cfg,lv,lv+1,success,()=>{
    setActionLocked(false);render();
    showToast(success?`${cfg.icon} ${cfg.name} 강화 성공 · Lv.${lv+1}${lv===0?' · 자동 장착':''}`:`◆ ${cfg.name} 강화 유지 · Lv.${lv} · 성공 ${odds.success}% / 유지 ${odds.hold}%`);
  });
}
function toggleLabPart(key=selectedLabPartKey){
  if(actionLocked)return;
  ...
  if(isResearchEquipped(key,d))d.equippedParts=equippedResearchKeys(d).filter(v=>v!==String(key));
  else d.equippedParts.push(String(key));
  d.equippedParts=equippedResearchKeys(d);save();render();showToast(`${cfg.icon} ${cfg.name} ${isResearchEquipped(key,d)?'장착 완료 · 효과 적용':'장착 해제 · 효과 미적용'}`);
}
function bindLabButtons(){
  document.querySelectorAll('#labView [data-lab-select]').forEach(b=>b.onclick=()=>{if(actionLocked)return;selectedLabPartKey=b.dataset.labSelect;renderLabView();});
  const upgrade=document.getElementById('labUpgradeBtn');if(upgrade)upgrade.onclick=()=>buyLabPart(selectedLabPartKey);
  const equip=document.getElementById('labEquipBtn');if(equip)equip.onclick=()=>toggleLabPart(selectedLabPartKey);
}

function syncLabSubView(){
  const upgrade=document.getElementById('labUpgradeSection'),fusion=document.getElementById('labFusionSection');
  const upgradeBtn=document.getElementById('labUpgradeModeBtn'),fusionBtn=document.getElementById('labFusionModeBtn');
  const isFusion=currentLabSubView==='fusion';
  if(upgrade)upgrade.classList.toggle('hidden',isFusion);
  if(fusion)fusion.classList.toggle('hidden',!isFusion);
  if(upgradeBtn){upgradeBtn.classList.toggle('active',!isFusion);upgradeBtn.setAttribute('aria-selected',!isFusion?'true':'false');}
  if(fusionBtn){fusionBtn.classList.toggle('active',isFusion);fusionBtn.setAttribute('aria-selected',isFusion?'true':'false');}
}
function setLabSubView(view){
  if(actionLocked)return;
  const next=view==='fusion'?'fusion':'upgrade';
  if(fusionGaugeRunning&&next!=='fusion')cancelFusionOverclock(false);
  currentLabSubView=next;
  syncLabSubView();
  if(currentLabSubView==='fusion')renderLabFusion();
}
function bindLabSubTabs(){
  const upgradeBtn=document.getElementById('labUpgradeModeBtn'),fusionBtn=document.getElementById('labFusionModeBtn');
  if(upgradeBtn)upgradeBtn.onclick=()=>setLabSubView('upgrade');
  if(fusionBtn)fusionBtn.onclick=()=>setLabSubView('fusion');
}

function fusionGradeForPosition(pos){
  const p=Math.max(0,Math.min(100,Number(pos)||0));
  return CORE_FUSION_GRADES.find(g=>p>=g.min&&p<=g.max)||null;
}
function fusionCoreAvailable(key,d=state.runData){return researchLevel(key,d)>=CORE_FUSION_MIN_LEVEL&&!fusionLinkForCore(key,d);}
function labFusionHTML(){
  const d=state.runData;d.fusionLinks=normalizeFusionLinks(d.fusionLinks,d.research);
  fusionSelectedKeys=fusionSelectedKeys.filter(k=>fusionCoreAvailable(k,d)).slice(0,2);
  const cards=Object.entries(RESEARCH_DATA).map(([key,cfg])=>{
    const lv=researchLevel(key,d),link=fusionLinkForCore(key,d),selected=fusionSelectedKeys.includes(key),available=lv>=CORE_FUSION_MIN_LEVEL&&!link;
    const stateText=link?`융합 완료 · +${Math.round((Number(link.boost)||0)*100)}%`:lv<CORE_FUSION_MIN_LEVEL?`Lv.${lv}/5`:'융합 가능';
    return `<button type="button" class="fusion-core-card ${selected?'selected':''} ${link?'fused':''}" data-fusion-core="${key}" ${available?'':'disabled'}><span>${cfg.icon}</span><div><small>${cfg.slot}</small><b>${cfg.name}</b><em>${stateText}</em></div></button>`;
  }).join('');
  const chosen=fusionSelectedKeys.map(k=>`${RESEARCH_DATA[k].icon} ${RESEARCH_DATA[k].name}`).join(' + ')||'Lv.5 코어 2개를 선택하세요';
  const canStart=fusionSelectedKeys.length===2&&!fusionGaugeRunning&&state.points>=CORE_FUSION_COST;
  const links=d.fusionLinks.length?d.fusionLinks.map((link,index)=>{const a=RESEARCH_DATA[link.a],b=RESEARCH_DATA[link.b],refund=Math.floor((Number(link.cost)||0)*CORE_FUSION_RESET_REFUND_RATE);return `<div class="fusion-link-row"><span>${a.icon} ${a.name}</span><i>×</i><span>${b.icon} ${b.name}</span><b>${link.grade} · 효과 +${Math.round(link.boost*100)}%</b><button class="fusion-reset-btn" type="button" data-fusion-reset="${index}">↻ 초기화${refund>0?` · ${refund.toLocaleString('ko-KR')}P 환급`:''}</button></div>`;}).join(''):'<div class="fusion-empty">아직 완성된 코어 융합이 없습니다.</div>';
  const result=fusionLastResult?`<div class="fusion-last-result ${fusionLastResult.success?'success':'fail'}"><b>${fusionLastResult.title}</b><span>${fusionLastResult.desc}</span></div>`:'';
  const costText=CORE_FUSION_COST.toLocaleString('ko-KR');
  const statusText=fusionGaugeRunning?'게이지를 보고 원하는 순간에 멈추세요.':fusionSelectedKeys.length<2?'두 코어를 선택하면 오버클럭을 시작할 수 있습니다.':state.points<CORE_FUSION_COST?`포인트 부족 · ${costText}P 필요`:`준비 완료 · 오버클럭 비용 ${costText}P`;
  return `<div class="fusion-head"><div><small>CORE FUSION · MANUAL OVERCLOCK</small><h3>🔬 코어 융합</h3><p>Lv.5 코어 2개를 선택하고 오버클럭 게이지를 직접 멈추세요. 중앙에 가까울수록 두 코어의 장착 효과가 더 크게 증폭됩니다. 코어는 소모되지 않습니다.</p></div><b>${d.fusionLinks.length} FUSION</b></div><div class="fusion-layout"><div class="fusion-core-grid">${cards}</div><div class="fusion-machine"><div class="fusion-selected-pair">${chosen}</div><div class="fusion-gauge-wrap"><div class="fusion-gauge-zones"><i class="zone-stable"></i><i class="zone-good"></i><i class="zone-great"></i><i class="zone-perfect"></i></div><div id="fusionGaugeNeedle" class="fusion-gauge-needle" style="left:${fusionGaugePosition}%"></div><div class="fusion-gauge-center"></div></div><div class="fusion-grade-guide"><span>STABLE +12%</span><span>GOOD +18%</span><span>GREAT +24%</span><span>PERFECT +30%</span></div><div class="fusion-cost-line"><span>오버클럭 비용</span><b>${costText}P</b><small>초기화 시 성공 융합 비용의 50% 환급</small></div><button id="fusionOverclockBtn" class="glass-btn fusion-overclock-btn ${fusionGaugeRunning?'running':''}" type="button" ${(!fusionGaugeRunning&&!canStart)?'disabled':''}>${fusionGaugeRunning?'⏹ 게이지 멈추기':'⚡ 오버클럭 시작'}</button><div id="fusionStatus" class="fusion-status">${statusText}</div>${result}</div></div><div class="fusion-links"><h4>완성된 융합 공명</h4>${links}</div>`;
}
function renderLabFusion(){const root=document.getElementById('labFusionContent');if(!root)return;root.innerHTML=labFusionHTML();bindFusionButtons();}
function toggleFusionCore(key){
  if(actionLocked||fusionGaugeRunning||!fusionCoreAvailable(key))return;
  if(fusionSelectedKeys.includes(key))fusionSelectedKeys=fusionSelectedKeys.filter(k=>k!==key);
  else if(fusionSelectedKeys.length<2)fusionSelectedKeys=[...fusionSelectedKeys,key];
  else fusionSelectedKeys=[fusionSelectedKeys[1],key];
  fusionLastResult=null;renderLabFusion();
}
function updateFusionGauge(ts){
  if(!fusionGaugeRunning)return;
  if(!fusionGaugeStartedAt)fusionGaugeStartedAt=ts;
  const cycle=1500,phase=((ts-fusionGaugeStartedAt)%cycle)/cycle;
  fusionGaugePosition=phase<.5?phase*200:(1-phase)*200;
  const needle=document.getElementById('fusionGaugeNeedle');if(needle)needle.style.left=`${fusionGaugePosition}%`;
  fusionGaugeRaf=requestAnimationFrame(updateFusionGauge);
}
function syncFusionRunningUi(){
  const d=state.runData,btn=document.getElementById('fusionOverclockBtn'),status=document.getElementById('fusionStatus');
  if(btn){
    btn.disabled=false;
    btn.classList.toggle('running',fusionGaugeRunning);
    btn.textContent=fusionGaugeRunning?'⏹ 게이지 멈추기':'⚡ 오버클럭 시작';
    if(!fusionGaugeRunning){
      const canStart=fusionSelectedKeys.length===2&&state.points>=CORE_FUSION_COST;
      btn.disabled=!canStart;
    }
  }
  if(status)status.textContent=fusionGaugeRunning?'게이지를 보고 원하는 순간에 멈추세요.':'오버클럭이 중지되었습니다.';
  document.querySelectorAll('#labFusionContent [data-fusion-core]').forEach(card=>{
    card.disabled=fusionGaugeRunning||!fusionCoreAvailable(card.dataset.fusionCore,d);
  });
  document.querySelectorAll('#labFusionContent [data-fusion-reset]').forEach(reset=>reset.disabled=fusionGaugeRunning);
}
function cancelFusionOverclock(showMessage=true){
  if(!fusionGaugeRunning)return;
  fusionGaugeRunning=false;
  fusionGaugeStartedAt=0;
  if(fusionGaugeRaf)cancelAnimationFrame(fusionGaugeRaf);
  fusionGaugeRaf=0;
  syncFusionRunningUi();
  if(showMessage)showToast('⚡ 오버클럭 취소 · 포인트는 소모되지 않았습니다.');
}
function startFusionOverclock(){
  if(fusionGaugeRunning)return;
  const d=state.runData;fusionSelectedKeys=fusionSelectedKeys.filter(k=>fusionCoreAvailable(k,d)).slice(0,2);
  if(fusionSelectedKeys.length!==2){showToast('🔬 Lv.5 코어 2개를 선택하세요.');renderLabFusion();return;}
  if(state.points<CORE_FUSION_COST){showToast(`⭐ 오버클럭에 ${CORE_FUSION_COST.toLocaleString('ko-KR')}P가 필요합니다.`);renderLabFusion();return;}
  fusionGaugeRunning=true;fusionGaugeStartedAt=0;fusionGaugePosition=0;fusionLastResult=null;currentLabSubView='fusion';
  syncLabSubView();
  syncFusionRunningUi();
  if(fusionGaugeRaf)cancelAnimationFrame(fusionGaugeRaf);
  fusionGaugeRaf=requestAnimationFrame(updateFusionGauge);
}
function stopFusionOverclock(){
  if(!fusionGaugeRunning)return;
  fusionGaugeRunning=false;fusionGaugeStartedAt=0;if(fusionGaugeRaf)cancelAnimationFrame(fusionGaugeRaf);fusionGaugeRaf=0;
  const d=state.runData,[a,b]=fusionSelectedKeys,grade=fusionGradeForPosition(fusionGaugePosition),accuracy=Math.max(0,Math.round(100-Math.abs(50-fusionGaugePosition)*2));
  if(!a||!b||!fusionCoreAvailable(a,d)||!fusionCoreAvailable(b,d)){
    fusionSelectedKeys=[];fusionLastResult={success:false,title:'융합 취소',desc:'선택한 코어 상태가 변경되었습니다.'};render();return;
  }
  if(state.points<CORE_FUSION_COST){fusionLastResult={success:false,title:'오버클럭 취소',desc:`포인트가 부족합니다. ${CORE_FUSION_COST.toLocaleString('ko-KR')}P가 필요합니다.`};render();return;}
  state.points-=CORE_FUSION_COST;state.pointsSpentTotal+=CORE_FUSION_COST;
  if(!grade){
    fusionLastResult={success:false,title:'OVERHEAT · 융합 실패',desc:`정밀도 ${accuracy}% · ${CORE_FUSION_COST.toLocaleString('ko-KR')}P 소모 · 코어는 유지됩니다.`};
    save();render();showToast('🔥 오버클럭 과열 · 코어 융합 실패');return;
  }
  d.fusionLinks=normalizeFusionLinks([...(d.fusionLinks||[]),{a,b,boost:grade.boost,grade:grade.name,cost:CORE_FUSION_COST,createdAt:Date.now()}],d.research);
  d.equippedParts=equippedResearchKeys(d);
  fusionLastResult={success:true,title:`${grade.name} · ${grade.label}`,desc:`정밀도 ${accuracy}% · 두 코어 장착 효과 +${Math.round(grade.boost*100)}%`};
  fusionSelectedKeys=[];save();render();showToast(`🔬 ${grade.name} 융합 성공 · 장착 중인 코어 효과 즉시 적용 +${Math.round(grade.boost*100)}%`);
}
function resetFusionLink(index){
  if(fusionGaugeRunning)return;
  const d=state.runData;d.fusionLinks=normalizeFusionLinks(d.fusionLinks,d.research);
  const i=Math.max(0,Math.floor(Number(index)||0)),link=d.fusionLinks[i];if(!link)return;
  const refund=Math.floor((Number(link.cost)||0)*CORE_FUSION_RESET_REFUND_RATE);
  const a=RESEARCH_DATA[link.a],b=RESEARCH_DATA[link.b];
  d.fusionLinks=d.fusionLinks.filter((_,idx)=>idx!==i);
  if(refund>0)state.points+=refund;
  fusionSelectedKeys=[];
  fusionLastResult={success:true,title:'융합 효과 초기화',desc:`${a?.name||link.a} + ${b?.name||link.b} 연결 해제${refund>0?` · ${refund.toLocaleString('ko-KR')}P 환급`:''} · 다시 융합할 수 있습니다.`};
  d.equippedParts=equippedResearchKeys(d);
  save();render();showToast(`↻ 코어 융합 초기화${refund>0?` · ${refund.toLocaleString('ko-KR')}P 환급`:''}`);
}
function bindFusionButtons(){
  document.querySelectorAll('#labFusionContent [data-fusion-core]').forEach(btn=>btn.onclick=()=>toggleFusionCore(btn.dataset.fusionCore));
  const btn=document.getElementById('fusionOverclockBtn');if(btn)btn.onclick=()=>{if(fusionGaugeRunning)stopFusionOverclock();else startFusionOverclock();};
  document.querySelectorAll('#labFusionContent [data-fusion-reset]').forEach(btn=>btn.onclick=()=>resetFusionLink(btn.dataset.fusionReset));
}

function setGameView(view){
  if(actionLocked)return;
  if(view!=='lab'&&fusionGaugeRunning)cancelFusionOverclock(false);
  currentGameView=['enhance','shop','lab','storage'].includes(view)?view:'enhance';
  closeModal();
  const main=document.querySelector('main.layout'),shop=document.getElementById('shopView'),lab=document.getElementById('labView'),storage=document.getElementById('storageView');
  ...
  if(storage)storage.classList.toggle('hidden',currentGameView!=='storage');
  ...
  document.body.classList.toggle('storage-view-active',currentGameView==='storage');
...
function storageHTML(){
  state.storageSlots=normalizeStorageSlots(state.storageSlots);
  const d=state.runData,l=level(),full=state.storageSlots.every(Boolean);
  const current=l>0?`<div class="storage-current-card"><div><small>CURRENT ODOR</small><h3>+${l} · ${DB[String(l)]?.name?.replace(/^\d+단계\s*:\s*/,'')||'지온 냄새'}</h3><p>예상 가치 <b>${formatGold(dbPrice(l))}</b></p></div><button class="glass-btn storage-store-btn" data-storage-store ${full?'disabled':''}>${full?'보관함 가득 참':'현재 냄새 보관'}</button></div>`:`<div class="storage-current-card empty-current"><div><small>CURRENT ODOR</small><h3>현재 보관할 냄새가 없습니다</h3><p>강화한 냄새를 최대 6개까지 보관할 수 있습니다.</p></div></div>`;
  const slots=state.storageSlots.map((slot,i)=>slot?`<article class="storage-slot filled"><div class="storage-slot-no">SLOT ${i+1}</div><div class="storage-slot-stage">+${slot.level}</div><h3>${DB[String(slot.level)]?.name?.replace(/^\d+단계\s*:\s*/,'')||'보관 냄새'}</h3><p>예상 가치 <b>${formatGold(dbPrice(slot.level))}</b></p><button class="glass-btn" data-storage-withdraw="${i}" ${l>0?'disabled':''}>${l>0?'현재 냄새 처리 후 꺼내기':'꺼내기'}</button></article>`:`<article class="storage-slot empty"><div class="storage-slot-no">SLOT ${i+1}</div><div class="storage-empty-icon">📦</div><h3>빈 보관 슬롯</h3><p>현재 냄새를 이곳에 안전하게 보관할 수 있습니다.</p></article>`).join('');
  return `${current}<div class="storage-slot-grid">${slots}</div>`;
}
function renderStorageView(){const root=document.getElementById('storagePageContent');if(!root)return;root.innerHTML=storageHTML();bindStorageButtons();}
function storeCurrentCard(){
  if(actionLocked)return;const l=level();if(l<=0){showToast('보관할 냄새가 없습니다.');return;}
  state.storageSlots=normalizeStorageSlots(state.storageSlots);const idx=state.storageSlots.findIndex(v=>!v);if(idx<0){showToast('📦 보관함이 가득 찼습니다.');return;}
  state.storageSlots[idx]={level:l,storedAt:Date.now(),warpSaleLock:Math.max(0,Number(state.runData.warpSaleLock)||0)};state.storageCount=Math.max(0,Number(state.storageCount)||0)+1;
  const d=state.runData;d.prev_level=l;d.level=0;d.status='READY';d.last_aux_effect='';d.warpBoostLevel=0;d.warpSaleLock=0;resetCombo(d);save();render();renderStorageView();showToast(`📦 ${l}단계 냄새를 SLOT ${idx+1}에 보관했습니다.`);
}
function withdrawStoredCard(index){
  if(actionLocked)return;state.storageSlots=normalizeStorageSlots(state.storageSlots);const i=Number(index),slot=state.storageSlots[i];if(!slot)return;
  if(level()>0){showToast('현재 냄새를 먼저 판매·경매·보관해야 합니다.');return;}
  const d=state.runData;d.prev_level=slot.level;d.level=slot.level;d.max_level=Math.max(Number(d.max_level)||0,slot.level);d.status='READY';d.last_aux_effect='';d.warpBoostLevel=0;d.warpSaleLock=Math.max(0,Number(slot.warpSaleLock)||0);resetCombo(d);unlockReachedWarps(d);state.storageSlots[i]=null;save();render();setGameView('enhance');showToast(`📦 SLOT ${i+1}에서 ${slot.level}단계 냄새를 꺼냈습니다. · 강화 화면으로 이동`);
}
function bindStorageButtons(){document.querySelectorAll('[data-storage-store]').forEach(b=>b.onclick=storeCurrentCard);document.querySelectorAll('[data-storage-withdraw]').forEach(b=>b.onclick=()=>withdrawStoredCard(b.dataset.storageWithdraw));}
function researchHTML(){return `<div class="modal-head research-modal-head"><div class="research-head-icon">🔬</div><div><h2>냄새 연구소</h2><p>16개 코어마다 서로 다른 성공/유지 확률로 최대 Lv.5까지 강화합니다.</p></div></div><button class="glass-btn" data-open-lab-view>연구소로 이동</button>`;}
...
function statsHTML(){
  ...
  const auctions=Math.max(0,Number(state.auctionCount)||0);
  ...
  const stored=Math.max(0,Number(state.storageCount)||0);
  ...
  return `<div class="modal-head stats-head"><div class="stats-head-icon">📈</div><div><h2>플레이 통계</h2><p>현재 세이브의 강화 기록을 한눈에 확인합니다.</p></div></div>
    ...
    <div class="stats-grid stats-grid-4">
      ...
      <article><small>경매 횟수</small><b class="stats-gold">${fmtNum(auctions)}</b></article>
      ...
      <article><small>보관 횟수</small><b>${fmtNum(stored)}</b></article>
...
function bindModal(kind){
  ...
  document.querySelectorAll("[data-buy-warp]").forEach(b=>b.onclick=()=>{
    ...
    playWarpAnimation(w,()=>{
      ...
      state.warpUses++;const prevWarp=d.level;d.prev_level=prevWarp;d.level=w;d.max_level=Math.max(d.max_level,w);d.status="SUCCESS";d.last_aux_effect="🚀 워프 완료";d.warpBoostLevel=activeResearchPower('warpTech',d);d.warpSaleLock=2;resetCombo(d);d._warpPrev=prevWarp;
    ...
    },()=>{const prevWarp=Number(d._warpPrev??w);delete d._warpPrev;save();showToast(`🚀 ${w}단계 워프 완료 · 판매/경매 전 강화하기 2회 필요`);runMilestoneOnly(prevWarp,w,()=>setActionLocked(false));});
  });
}
...
(function bindFinalHoldEnhance(){
  ...
  const HOLD_MS=1500;let holding=false,start=0,raf=0;
  const resetHold=(cancelled=false)=>{
    if(raf)cancelAnimationFrame(raf);raf=0;holding=false;start=0;
    enhanceButton.style.setProperty('--final-hold','0');
    enhanceButton.classList.remove('final-holding','final-hold-complete');
    enhanceButton.textContent=level()>=MAX_LEVEL?'55단계 MAX':'강화하기';
    if(cancelled&&level()===MAX_LEVEL-1&&!actionLocked)showToast('54→55 강화 취소 · 강화하기 버튼을 끝까지 꾹 눌러주세요.');
  };
  const beginHold=(e)=>{
    if(level()!==MAX_LEVEL-1||actionLocked||enhanceButton.disabled)return;
    if(e?.pointerType&&e.button!==undefined&&e.button!==0)return;
    e?.preventDefault?.();holding=true;start=performance.now();enhanceButton.classList.add('final-holding');
    const tick=(now)=>{
      if(!holding)return;
      const progress=Math.min(1,(now-start)/HOLD_MS);
      enhanceButton.style.setProperty('--final-hold',String(progress*100));
      // 문구는 항상 "강화하기"로 유지하고 게이지만 채운다.
      enhanceButton.textContent='강화하기';
      if(progress>=1){
        holding=false;enhanceButton.classList.add('final-hold-complete');finalHoldAuthorized=true;
        impactFlash(.38);cardBurst('#fde047',82,190);
        setTimeout(()=>{resetHold(false);enhance('normal');},90);return;
      }
  ...
  enhanceButton.addEventListener('pointerdown',beginHold);
  enhanceButton.addEventListener('pointerup',cancelHold);
  enhanceButton.addEventListener('pointercancel',cancelHold);
  enhanceButton.addEventListener('pointerleave',cancelHold);
...
document.getElementById("auctionBtn")?.addEventListener("click",auction);
...
function resetGame(){
  ...
  if(!ok)return;
  document.querySelectorAll('.card-draw-overlay,.berserk-roulette-overlay,.auction-roulette-overlay,.frenzy-event-overlay,.warp-fx-overlay,.system-choice-overlay,.result-fx-layer').forEach(e=>e.remove());
  cleanupTransientEffects();
  state=clone(INITIAL);
  save();
  render();
